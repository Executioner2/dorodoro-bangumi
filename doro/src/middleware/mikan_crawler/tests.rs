...
async fn test_list_source_group() {
    let mikan = BangumiCrawler::global().get_crawler("mikan").unwrap();
    let ret = mikan.list_source_group(Resource {
        id: "3706".to_string(),
        name: "新 吊带袜天使".to_string(),
        link: "/Home/Bangumi/3702".to_string(),
        last_update: None,
        image_url: "/images/Bangumi/202507/fb4e93af.jpg?width=400&height=400&format=webp".to_string(),
...
async fn test_list_subscribe_sources() {
    let mikan = BangumiCrawler::global().get_crawler("mikan").unwrap();
    let ret = mikan.list_subscribe_sources(Resource {
        id: "3706".to_string(),
        name: "新 吊带袜天使".to_string(),
        link: "/Home/Bangumi/3702".to_string(),
        last_update: None,
